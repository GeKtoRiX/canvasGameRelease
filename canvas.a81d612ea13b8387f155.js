...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  margin: 0;\n  background-color: #000000;\n  position: relative; }\n\nh1,\np {\n  margin: 0; }\n\np {\n  margin-bottom: 10px; }\n\n.score {\n  display: inline-block;\n  position: absolute;\n  top: 5%;\n  left: 5%;\n  color: limegreen;\n  font-size: 50px; }\n\n.menu {\n  display: inline-block;\n  width: 15%;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  text-align: center; }\n\n.bg-white {\n  border-radius: 20px;\n  padding: 20px;\n  background-color: #fff;\n  opacity: 0.95; }\n\n.gameOn {\n  width: 90%;\n  height: 30px;\n  border: 0;\n  border-radius: 10px;\n  background-color: #1b83e4;\n  color: white;\n  font-size: 15px; }\n\n.gameOn:hover {\n  background-color: goldenrod; }\n", "",{"version":3,"sources":["webpack://./src/main.css"],"names":[],"mappings":"AAAA;EACE,SAAS;EACT,yBAAyB;EACzB,kBAAkB,EAAA;;AAGpB;;EAEE,SAAS,EAAA;;AAGX;EACE,mBAAmB,EAAA;;AAGrB;EACE,qBAAqB;EACrB,kBAAkB;EAClB,OAAO;EACP,QAAQ;EACR,gBAAgB;EAChB,eAAe,EAAA;;AAGjB;EACE,qBAAqB;EACrB,UAAU;EACV,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,gCAAgC;EAChC,kBAAkB,EAAA;;AAGpB;EACE,mBAAmB;EACnB,aAAa;EACb,sBAAsB;EACtB,aAAa,EAAA;;AAGf;EACI,UAAU;EACV,YAAY;EACZ,SAAS;EACT,mBAAmB;EACnB,yBAAyB;EACzB,YAAY;EACZ,eAAe,EAAA;;AAEnB;EACI,2BAA2B,EAAA","sourcesContent":["body {\r\n  margin: 0;\r\n  background-color: #000000;\r\n  position: relative;\r\n}\r\n\r\nh1,\r\np {\r\n  margin: 0;\r\n}\r\n\r\np {\r\n  margin-bottom: 10px;\r\n}\r\n\r\n.score {\r\n  display: inline-block;\r\n  position: absolute;\r\n  top: 5%;\r\n  left: 5%;\r\n  color: limegreen;\r\n  font-size: 50px;\r\n}\r\n\r\n.menu {\r\n  display: inline-block;\r\n  width: 15%;\r\n  position: absolute;\r\n  top: 50%;\r\n  left: 50%;\r\n  transform: translate(-50%, -50%);\r\n  text-align: center;\r\n}\r\n\r\n.bg-white {\r\n  border-radius: 20px;\r\n  padding: 20px;\r\n  background-color: #fff;\r\n  opacity: 0.95;\r\n}\r\n\r\n.gameOn{\r\n    width: 90%;\r\n    height: 30px;\r\n    border: 0;\r\n    border-radius: 10px;\r\n    background-color: #1b83e4;\r\n    color: white;\r\n    font-size: 15px;\r\n}\r\n.gameOn:hover{\r\n    background-color: goldenrod;\r\n}"],"sourceRoot":""}]);
// Exports
...
var gameOn = document.querySelector(".gameOn");
htmlCanvas.width = window.innerWidth - 4;
htmlCanvas.height = window.innerHeight - 4;
window.addEventListener("resize", function () {
  htmlCanvas.width = window.innerWidth - 4;
  htmlCanvas.height = window.innerHeight - 4; // init();
});
window.addEventListener("mousemove", function (event) {
  mouse.x = event.clientX;
  mouse.y = event.clientY;
});
gameOn.addEventListener("click", function () {
  reset();
  animate();
  spawnEnemies();
...
setTimeout(function () {
  window.addEventListener("click", function (event) {
    ...
    projectiles.push(new Projectile(center.x, center.y, 8, {
      x: Math.cos(angle) * 10,
      y: Math.sin(angle) * 10
    }, "white"));
  });
...
var Projectile = /*#__PURE__*/function () {
  function Projectile(x, y, radius, velocity, color) {
...
var Enemy = /*#__PURE__*/function () {
  function Enemy(x, y, radius, velocity, color) {
...
var particles = [];
var enemies = [];
var player = new Player(center.x, center.y, 64, "hsl(".concat(Math.random() * 360, ",50%,50%)"));
var score = 0;
var spawnSpeed;
var enemySpeed;
...
function reset() {
  ...
  particles = [];
  enemies = [];
  player = new Player(center.x, center.y, 64, "hsl(".concat(Math.random() * 360, ", 50%, 50%)"));
  spawnSpeed = 2000;
  enemySpeed = 1;
  score = 0;
...
function animate() {
  ...
  player.update();
  projectiles.forEach(function (projectile, indexOutOfBounds) {
    projectile.update(); // Projectile out of bounds.

    if (projectile.x + projectile.radius < 0 || projectile.x - projectile.radius > htmlCanvas.width || projectile.y + projectile.radius < 0 || projectile.y - projectile.radius > htmlCanvas.height) {
      setTimeout(function () {
        projectiles.splice(indexOutOfBounds, 1);
      }, 0);
    }
  });
  particles.forEach(function (particle, partIndex) {
    if (particle.alpha <= 0) {
  ...
  enemies.forEach(function (enemy, enemyIndex) {
    enemy.update(); // End the game.

    var dist = Math.hypot(player.x - enemy.x, player.y - enemy.y);

    if (dist - enemy.radius - player.radius < 1) {
      if (player.radius > 16) {
        gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(player, {
      ...
      for (var i = 0; i < enemy.radius * 2; i++) {
        particles.push(new Particle(enemy.x, enemy.y, Math.random() * 3, {
    ...
    projectiles.forEach(function (projectile, projectileIndex) {
      ...
      var dist = Math.hypot(projectile.x - enemy.x, projectile.y - enemy.y); // Kill arcs.

      if (dist - enemy.radius - projectile.radius < 1) {
        for (var _i = 0; _i < enemy.radius * 2; _i++) {
        ...
        setTimeout(function () {
          if (enemy.radius > 30) {
            ...
            gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(enemy, {
              radius: enemy.radius - 10
            });
          } else {
            enemies.splice(enemyIndex, 1); // Increase SpawnSpeed.
